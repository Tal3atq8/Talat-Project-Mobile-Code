...
class NetworkService {
  ...
  Future<Response> post(String url, {Map<String, dynamic>? headers, body, encoding}) async {
    _connectivityResult = await (Connectivity().checkConnectivity());
    if (_connectivityResult == ConnectivityResult.none) {
      response = Response(
          requestOptions: RequestOptions(path: ''),
      ...
      response = await dio.post(url, options: Options(headers: headers), data: body);
    }
    return response;
  }

  Future<Response> put(String url, {Map<String, dynamic>? headers, body, encoding}) async {
    _connectivityResult = await (Connectivity().checkConnectivity());
    if (_connectivityResult == ConnectivityResult.none) {
      response = Response(
          requestOptions: RequestOptions(path: ''),
      ...
      response = await dio.put(url, options: Options(headers: headers), data: body);
    }
    return response;
  }

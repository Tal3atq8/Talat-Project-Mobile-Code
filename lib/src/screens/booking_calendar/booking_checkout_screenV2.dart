                ...
                children: [
                  ...
                  activityDetailItem.value.is_location == 0 || activityDetailItem.value.is_location == ""
                      ? Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 16.0),
                          child: /*Text(
                            "${serviceProviderName.value} ${toLabelValue('no_location')}",
                            style: TextStyle(
                                color: ColorConstant.blackColor,
                                fontSize: 16,
              ...
              child: ListTile(
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: CachedNetworkImage(
                          imageUrl:
                          activityDetailItem.value.images?.first.imageUrl ??
                              '',
                          fit: BoxFit.fill,
                          errorWidget: (context, url, error) {
                            return const PlaceholderImage();
                ...
                title: Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${generalSetting?.result?.first.currency ?? ''} ${activityDetailItem.value.discountedPrice == 0 ? '${(double.parse(activityDetailItem.value.initialPrice.toString()))}' : '${(double.parse(activityDetailItem.value.discountedPrice.toString()))}'}',
                      style: txtStyleTitleBoldBlack14(
                          color: ColorConstant.appThemeColor),
                    )
                  ],
            ...
            CommonMapWidget(
              ...
              markers: {
                Marker(
                  ...
                  markerId: MarkerId("${activityDetailItem.value.itemId}"),
                  position: LatLng(
                      double.parse("${activityDetailItem.value.latitude}"),
                      double.parse("${activityDetailItem.value.longitude}")),
                  // infoWindow: InfoWindow(title: "${result?.providerName}"),
                  icon: BitmapDescriptor.defaultMarker,
                )
                    ...
                    return ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (activityDetailItem.value.initialPrice == 0) {
                          ...
                          try {
                            RequestPayments(
                                context, OnSuccess, OnFailure, false);
                          } catch (e) {
                            debugPrint(e.toString());
                          }
                        }
